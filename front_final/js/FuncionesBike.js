function autoInicioCategoria(){
    ...
    $.ajax({
        url:"http://132.226.119.207:80/api/Category/all",
        type:"GET",
        datatype:"JSON",
...
function cargarDatosBike(id) {
    $.ajax({
        dataType: 'json',
        url:"http://132.226.119.207:80/api/Bike/"+id,
    ...
    if($("#name2").val().length == 0 || $("#brand").val().length == 0 || $("#year").val().length == 0 || $("#description2").val().length == 0){
       alert("Todos los campos son obligatorios")
            ...
            $.ajax({
                ...
                url:"http://132.226.119.207:80/api/Bike/save",
    ...
    $.ajax(
        {
            dataType: 'json',
            data: dataToSend,
            url:"http://132.226.119.207:80/api/Bike/"+idElemento,
...
function actualizar(idElemento) {
    ...
    if($("#name2").val().length == 0 || $("#brand").val().length == 0 || $("#year").val().length == 0 || $("#description2").val().length == 0){
        ...
        $.ajax({
            ...
            data: dataToSend,
            contentType: "application/JSON",
            url:"http://132.226.119.207:80/api/Bike/update",
